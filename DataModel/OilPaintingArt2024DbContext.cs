...
public partial class OilPaintingArt2024DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.OilPaintingArtId).HasName("PK__OilPaint__708184D8735E4E16");
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666B43CDA8971");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__SystemAc__349DA586AB875DA0");

            entity.ToTable("SystemAccount");

            entity.HasIndex(e => e.AccountEmail, "UQ__SystemAc__FC770D33818FDF25").IsUnique();
